  ...
  return (
    <div className=" z-10 md:sticky top-10 my-10 flex gap-x-10 gap-y-20 items-center justify-evenly md:justify-between flex-wrap-reverse md:flex-nowrap">
      <motion.div
        ...
        initial="hidden"
        whileInView="show"
        className=" md:flex-1 ml-12"
      >
        <img
          className=" animate-pulse max-w-md xl:max-w-xl w-full"
      ...
      <motion.div
        ...
        initial="hidden"
        whileInView="show"
        className="flex-1 max-w-xl md:max-w-md w-full mx-auto md:mx-0 md:mt-36 pr-16 text-center md:text-left"
      >
