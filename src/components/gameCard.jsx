...
const GameCard = ({
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      whileInView="show"
      className=" text-center relative rounded-2xl w-full md:w-[30%] basis shrink-0 grow bg-gray-900 bg-opacity-50 p-5"
    >
      <img
      ...
      <p className=" text-zinc-400 text-sm font-medium text-center mt-7 mb-4">
        {card_p}
      </p>
